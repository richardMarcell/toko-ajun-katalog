...
import { defaultIpLocationsDevelopment } from "./datas/default-ip-locations-development";
import { getIpLocationIds } from "@/lib/services/permissions/get-ip-location-ids";
import { ipLocationHasPermissions } from "../schema/ip-location-has-permissions";
...
function getIpLocationHasPermissionList(): Array<{
  ...
  return defaultIpLocationsDevelopment.map((ipLocation) => {
    return {
