...
import verifyUserAccessCodeAndPassword from "@/lib/services/sales/verify-user-access-code-and-password";
...
// TODO : create new component with name ButtonRequestAccessCode to use for all request access code
export default function ButtonReprintReceipt({
  handlePrintReceipt,
}: {
  handlePrintReceipt: () => void;
}) {
  const [state, formAction] = useActionState(
    verifyUserAccessCodeAndPassword,
    initialValue,
  );
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Konfirmasi Reprint Struk</AlertDialogTitle>
          <AlertDialogDescription>
