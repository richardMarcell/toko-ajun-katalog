...
import { ProductQuantityFunctionProps } from "@/types/domains/pos/food-corner/sales/order";
...
export function QuantityButtonGroup({
  ...
  return (
    <div className="flex items-center gap-2" data-testid="qty-control">
      <button
      ...
      <div
        className="flex h-8 w-8 items-center justify-center rounded-lg border bg-gray-100 p-[10px] font-bold"
