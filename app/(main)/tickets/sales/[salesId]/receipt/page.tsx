...
import { HeaderReceipt } from "@/components/internal/domains/tickets/sales/receipt/header-receipt";
import { SummaryReceipt } from "@/components/internal/domains/tickets/sales/receipt/summary-receipt";
import { TableListSale } from "@/components/internal/domains/tickets/sales/receipt/table-list-sale";
import { Card, CardContent } from "@/components/ui/card";
import { PermissionEnum } from "@/lib/enums/PermissionEnum";
import { getUserAuthenticated } from "@/lib/services/auth/get-user-authenticated";
import { can } from "@/lib/services/permissions/can";
import { getSale } from "@/repositories/domain/tickets/get-sale";
import { notFound, redirect } from "next/navigation";

export default async function TicketSalesReceiptPage({
  params,
}: {
