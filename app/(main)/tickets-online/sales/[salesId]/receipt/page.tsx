...
import { HeaderReceipt } from "@/components/internal/domains/tickets-online/sales/receipt/header-receipt";
import { SummaryReceipt } from "@/components/internal/domains/tickets-online/sales/receipt/summary-receipt";
import { TableListSale } from "@/components/internal/domains/tickets-online/sales/receipt/table-list-sale";
import { Card, CardContent } from "@/components/ui/card";
import { PermissionEnum } from "@/lib/enums/PermissionEnum";
import { getUserAuthenticated } from "@/lib/services/auth/get-user-authenticated";
import { can } from "@/lib/services/permissions/can";
import { getSale } from "@/repositories/domain/tickets-online/get-sale";
import { notFound, redirect } from "next/navigation";

export default async function TicketOnlineSalesReceiptPage({
  params,
}: {
      ...
      <Card className="lg:w-1/2 xl:w-2/6">
        <CardContent className="flex w-full flex-col justify-center gap-4 p-4">
          ...
          <ButtonPrintReceipt
            ...
            redirectUrl="/tickets-online/sales/create"
          />
        </CardContent>
      </Card>
    </div>
