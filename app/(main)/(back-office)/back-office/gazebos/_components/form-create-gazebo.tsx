...
import storeGazebo from "../create/_actions/store-gazebo";

export default function FormCreateGazebo() {
  const [state, formAction] = useActionState(storeGazebo, initialValue);
