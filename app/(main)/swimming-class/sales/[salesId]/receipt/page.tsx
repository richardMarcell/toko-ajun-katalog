...
import { HeaderReceipt } from "@/components/internal/domains/swimming-class/sales/receipt/header-receipt";
import { SummaryReceipt } from "@/components/internal/domains/swimming-class/sales/receipt/summary-receipt";
import { TableListSale } from "@/components/internal/domains/swimming-class/sales/receipt/table-list-sale";
import { Card, CardContent } from "@/components/ui/card";
import { PermissionEnum } from "@/lib/enums/PermissionEnum";
import { getUserAuthenticated } from "@/lib/services/auth/get-user-authenticated";
import { can } from "@/lib/services/permissions/can";
import { getSale } from "@/repositories/domain/swimming-class/get-sale";
...
export default async function SalesReceiptPage({
  ...
  await can({
    permissionNames: [PermissionEnum.SWIMMING_CLASS_SALES_RECEIPT],
    user: user,
  });
