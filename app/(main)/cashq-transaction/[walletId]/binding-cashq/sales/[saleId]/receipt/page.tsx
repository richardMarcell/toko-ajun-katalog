...
export default async function BindingCashQReceiptPage({
  params,
}: {
  ...
  await can({
    permissionNames: [PermissionEnum.CASHQ_TRANSACTION_BINDING_CASHQ_RECEIPT],
    user: user,
  });
        ...
        <CardContent className="flex w-full flex-col justify-center gap-4 p-4">
          <div className="w-full border p-4">
            ...
            <Table>
              <TableBody>
                ...
                <TableRow className="border-none">
                  ...
                  <TableCell>:</TableCell>
                  <TableCell>
                    {saleReceiptWithAdditional.customer_name}
                  </TableCell>
                </TableRow>
                <TableRow className="border-none">
            ...
            <Table className="mt-8">
              ...
              <TableBody>
                {saleReceiptWithAdditional.sales_details.map(
                  (detail, index) => (
              ...
              <TableBody>
                <TableRow className="border-none">
                  ...
                  <TableCell className="text-right">
                    {formatNumberToCurrency(
                      Number(saleReceiptWithAdditional.total_gross),
                    )}
                  </TableCell>
                </TableRow>
                <TableRow className="border-none">
                ...
                <TableRow className="border-none">
                  ...
                  <TableCell className="text-right text-2xl font-bold">
                    {formatNumberToCurrency(
                      Number(saleReceiptWithAdditional.grand_total),
                    )}
                  </TableCell>
                </TableRow>
              </TableBody>
