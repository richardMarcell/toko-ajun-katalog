import { getSale } from "@/app/(main)/pos/resto/_repositories/get-sale";
...
export default async function RestoPatioReceiptPage({
  params,
}: {
  params: Promise<{
  ...
  await can({
    permissionNames: [PermissionEnum.RESTO_PATIO_SALES_RECEIPT],
    user: user,
  });
