...
import { HeaderReceipt } from "@/components/internal/domains/pos/locker/sales/receipt/header-receipt";
import { SummaryReceipt } from "@/components/internal/domains/pos/locker/sales/receipt/summary-receipt";
import { TableListSale } from "@/components/internal/domains/pos/locker/sales/receipt/table-list-sale";
import { Card, CardContent } from "@/components/ui/card";
import { PermissionEnum } from "@/lib/enums/PermissionEnum";
import { getUserAuthenticated } from "@/lib/services/auth/get-user-authenticated";
import { can } from "@/lib/services/permissions/can";
import { getSale } from "@/repositories/domain/pos/locker/sales/get-sale";
...
export default async function SalesReceiptPage({
  ...
  await can({
    permissionNames: [PermissionEnum.LOCKER_SALES_RECEIPT],
    user: user,
  });
