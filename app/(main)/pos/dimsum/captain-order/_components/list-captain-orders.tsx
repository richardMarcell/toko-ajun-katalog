      ...
      <CardContent className="space-y-4 p-4">
              ...
              {captainOrder.captain_order_details.length > 3 && (
                <TableRow className="border-none">
                  <TableCell colSpan={3} className="px-0 text-qubu_blue">
                    <Link
                      href={`/pos/dimsum/captain-order/${captainOrder.id}`}
        ...
        <div className="flex items-center justify-center gap-2">
          <Button
            ...
            asChild
          >
            <Link href={`/pos/dimsum/captain-order/${captainOrder.id}`}>
              See Detail
            </Link>
          </Button>
          ...
          {captainOrder.total_paid_qty < captainOrder.total_qty && (
            <Button className="w-full bg-qubu_blue" asChild>
              <Link href={`/pos/dimsum/captain-order/${captainOrder.id}/edit`}>
                Pay Bills
              </Link>
            </Button>
          )}
